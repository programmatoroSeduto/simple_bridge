...
#include "ros2_bridge_support_pkg/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _MyCustomMessage_type_support_symbol_names_t _MyCustomMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_bridge_support_pkg, msg, MyCustomMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_bridge_support_pkg, msg, MyCustomMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_ros2_bridge_support_pkg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_bridge_support_pkg, msg, MyCustomMessage)() {
  return &::ros2_bridge_support_pkg::msg::rosidl_typesupport_c::MyCustomMessage_message_type_support_handle;
}
