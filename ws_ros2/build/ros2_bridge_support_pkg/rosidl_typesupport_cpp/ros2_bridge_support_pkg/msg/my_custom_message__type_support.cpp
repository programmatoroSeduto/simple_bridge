...
static const _MyCustomMessage_type_support_symbol_names_t _MyCustomMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_bridge_support_pkg, msg, MyCustomMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_bridge_support_pkg, msg, MyCustomMessage)),
  }
};
...
{
  return &::ros2_bridge_support_pkg::msg::rosidl_typesupport_cpp::MyCustomMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_bridge_support_pkg, msg, MyCustomMessage)() {
  return get_message_type_support_handle<ros2_bridge_support_pkg::msg::MyCustomMessage>();
}
