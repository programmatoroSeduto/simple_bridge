...
: ${AMENT_CURRENT_PREFIX:="/root/simple_bridge/ws_ros2/install/my_custom_sender"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_custom_sender/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_custom_sender/environment/path.sh"
