...
namespace cast_tools
{
    ...
    /* TEMPLATE for topic mapping (message ???)
    ...
    */
    ...
    /* TEMPLATE for service mapping (service package::srv::service)
...
public:
    ...
    {
        // @todo static mapping here

        OUTLOG( "online!" );
    }

private:
    // @todo put here the definitions of your services and topics
    // ...
