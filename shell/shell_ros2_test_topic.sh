...
terminator -e "source /opt/ros/foxy/setup.bash && source /root/simple_bridge/ws_ros2/install/setup.sh && ros2 topic echo /bridge_topic/custom_topic std_msgs/msg/String" -T "ros2 subscriber"
